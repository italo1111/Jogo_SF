...
namespace Jogo_SF
{
    internal class Jogo
    {
        ...
        public Jogo()
        {
            ...
            todasCartas.Add(new Piloto("Ayrton Senna", 370, 18000, 800));
            todasCartas.Add(new Piloto("Lewis Hamilton", 350, 17500, 950));
            todasCartas.Add(new Piloto("Max Verstappen", 340, 16500, 1000));
            todasCartas.Add(new Piloto("Lando Norris", 325, 16800, 860));
            todasCartas.Add(new Piloto("Sergio Pérez", 335, 16800, 880));
            todasCartas.Add(new Piloto("Charles Leclerc", 330, 16200, 850));
            todasCartas.Add(new Piloto("Fernando Alonso", 320, 16000, 860));
            todasCartas.Add(new Piloto("Oscar Piastri", 320, 16300, 850));
        }
